...
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InN3cnhxcGJmc3RudmhreW12bWNjIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTgyNzEzMzIsImV4cCI6MjAxMzg0NzMzMn0.5b2Qxjwbovc0C405AefJZ2Duz9_WVG7WkF8-6djz9rs' // Replace with your Supabase API Key
            ...
            <div className="bg-[#F9FAFB] h-full w-full flex items-center">
                <div className="h-max mx-auto flex flex-col items-center">
                    ...
                    <form onSubmit={onSubmit}>
                        ...
                        <div>
                            <input className="bg-green-700 w-full my-10 py-2 rounded-md text-white font-bold cursor-pointer" type="submit" value="Login" />
                        </div>
                    </form>
                </div>
            </div>
